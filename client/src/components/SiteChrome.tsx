...
export function Footer() { return <footer className="bg-forest text-white"><div className="container grid gap-12 py-16 md:grid-cols-[1.2fr_0.9fr_0.9fr] md:py-20"><div><Logo light /><p className="mt-6 max-w-sm text-sm leading-7 text-white/65">{company.description}</p><p className="mt-6 text-xs font-bold uppercase tracking-[0.18em] text-ocre">{company.region}</p></div><div><p className="eyebrow text-white/45">Explorar</p><div className="mt-5 flex flex-col gap-3 text-sm text-white/75"><a href="/#a-vertente" className="hover:text-ocre">A Vertente</a><a href="/#servicos" className="hover:text-ocre">Serviços</a><a href="/servicos/programa-reflorestar" className="hover:text-ocre">Reflorestar</a><a href="/servicos/laudos-e-licencas" className="hover:text-ocre">Laudos e licenças</a><a href="/servicos/conservacao-solo-agua" className="hover:text-ocre">Conservação de solo e água</a><a href="/#contato" className="hover:text-ocre">Contato</a></div></div><div><p className="eyebrow text-white/45">Converse</p><div className="mt-5 flex flex-col gap-3 text-sm text-white/75"><a href={company.phoneLink} className="hover:text-ocre"><span className="block text-[10px] font-bold uppercase tracking-[0.15em] text-white/40">Telefone · WhatsApp</span>{company.phoneDisplay}</a><a href={`mailto:${company.email}`} className="hover:text-ocre"><span className="block text-[10px] font-bold uppercase tracking-[0.15em] text-white/40">E-mail</span>{company.email}</a><a href={company.instagramUrl} target="_blank" rel="noreferrer" className="hover:text-ocre"><span className="block text-[10px] font-bold uppercase tracking-[0.15em] text-white/40">Instagram</span>{company.instagramHandle}</a></div></div></div><div className="border-t border-white/10"><div className="container flex flex-col gap-2 py-5 text-[11px] uppercase tracking-[0.14em] text-white/40 md:flex-row md:justify-between"><span>© {new Date().getFullYear()} Vertente Vegetal</span><span>Consultoria agrícola e ambiental</span></div></div></footer>; }
